...
| **生产化边界** | Sprint 13 S01-S04 已具备 production-shaped acceptance standard ready（代码、部署契约、门禁已补齐），但历史 lab evidence 仍为 `production_shape.status=pending`；不得把 lab kubeconfig、kubectl proxy、port-forward、dev gateway 或历史相邻 live evidence 等同于 runtime/production ready；S05-S07 B 轨也必须按同一 production-shaped proof_items 标准验收 |
