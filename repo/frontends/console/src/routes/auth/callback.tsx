...
/**
 * `/auth/callback` — OIDC 回调换 Token（P0）。
 *
 * 状态机（UX §6.2）：
 *   loading / error_missing_params / error_state_mismatch / error_token / success
 *
 * 流程：读取 code + state → 校验 state → POST /auth/token → 写会话 → 跳 returnTo 或 /
 */
