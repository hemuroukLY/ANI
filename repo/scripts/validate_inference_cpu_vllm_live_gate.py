#!/usr/bin/env python3
"""Validate the CPU vLLM InferenceService live gate contract."""
...
DEFAULT_GATE = ROOT / "deploy/real-k8s-lab/inference-cpu-vllm-live-gate.yaml"
DEFAULT_EVIDENCE = ROOT / "development-records/live-evidence/inference-cpu-vllm-live-20260815.json"
...
def fail(message: str) -> None:
    raise SystemExit(f"inference cpu vllm live gate invalid: {message}")
...
def main() -> None:
    ...
    print("inference cpu vllm live gate valid")
