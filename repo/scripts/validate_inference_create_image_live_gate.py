#!/usr/bin/env python3
"""Validate the create-image InferenceService live gate."""
...
DEFAULT_GATE = ROOT / "deploy/real-k8s-lab/inference-create-image-live-gate.yaml"
DEFAULT_EVIDENCE = ROOT / "development-records/live-evidence/inference-create-image-live-20260818.json"
...
REQUIRED_CHECKS = {
    ...
    "default-engine-image-env-removed",
    ...
    "create-unpinned-image-rejected",
    "create-model",
...
def fail(message: str) -> None:
    raise SystemExit(f"inference create image live gate invalid: {message}")
...
def main() -> None:
    ...
    print("inference create image live gate valid")
